...
use GarmentManagementApi\Controllers\StitchingController;
use GarmentManagementApi\Middleware\RoleMiddleware;

class StitchingRoutes {
    public static function register() {
        $controller = new StitchingController();
        $namespace = 'garment-management/v1';

        register_rest_route($namespace, '/stitching', [
            'methods' => 'GET',
        ...
        register_rest_route($namespace, '/stitching/(?P<id>\d+)', [
            'methods' => 'GET',
